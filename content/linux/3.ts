...
const capitulo: Capitulo = {
  ...
  descripcion:
    "En Linux, todo — absolutamente todo — es un archivo.",
  tiempoMin: 5,
  preguntaGancho:
  ...
  secciones: [
    ...
    },
    {
      ...
      texto:
        "Así luce el árbol de directorios de Linux desde la raíz.",
      componente: "filesystem-tree",
    },
    {
      tipo: "quiz",
      pregunta: "¿Dónde buscarías primero si un servicio de Linux está fallando y quieres saber por qué?",
      opciones: [
        ...
        { texto: "En `/var/log`, porque ahí se guardan los registros de eventos.", correcta: true },
        { texto: "En `/dev`, porque los dispositivos reportan sus errores ahí.", correcta: false },
      ],
      feedbackCorrecto:
