...
const capitulo: Capitulo = {
  ...
  descripcion:
    "¿Quién puede leer qué? ¿Quién puede borrar qué?",
  tiempoMin: 6,
  preguntaGancho:
  ...
  secciones: [
    ...
    },
    {
      ...
      texto:
        "Así se lee una cadena de permisos completa en Linux.",
      componente: "permissions-decoder",
    },
    {
      tipo: "quiz",
      pregunta: "Un archivo tiene permisos `rw-r--r--`. ¿Qué puede hacer un usuario que no es el dueño ni está en el grupo?",
      opciones: [
