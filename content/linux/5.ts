...
const capitulo: Capitulo = {
  ...
  secciones: [
    ...
    },
    {
      ...
      opciones: [
        { texto: "Está consumiendo demasiada memoria y el sistema lo suspendió.", correcta: false },
        { texto: "Terminó su ejecución pero su proceso padre aún no recogió su código de salida.", correcta: true },
        { texto: "Está esperando acceso al disco y bloqueó otros procesos.", correcta: false },
        { texto: "Fue detenido con `kill -9` y no pudo limpiar sus recursos.", correcta: false },
      ],
      feedbackCorrecto:
