...
const capitulo: Capitulo = {
  ...
  secciones: [
    ...
    },
    {
      ...
      opciones: [
        {
          texto: "TCP, porque garantiza que el audio llegue sin errores.",
          correcta: false,
        },
        {
          texto:
            "UDP, porque es más importante tener baja latencia que recibir cada paquete.",
          correcta: true,
        },
        {
          texto: "TCP, porque establece una conexión segura antes de hablar.",
          correcta: false,
        },
        {
          texto: "UDP, porque cifra los datos mejor que TCP.",
          correcta: false,
        },
      ],
      feedbackCorrecto:
