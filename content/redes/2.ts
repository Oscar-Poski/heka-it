      ...
      secciones: [
        {
          ...
          opciones: [
            { texto: "La IP privada es más rápida que la pública.", correcta: false },
            {
              texto:
            ...
            {
              texto: "La IP pública la asigna tu router; la privada la asigna Google.",
              correcta: false,
            },
            { texto: "Son lo mismo, solo cambia el nombre según el país.", correcta: false },
          ],
          feedbackCorrecto:
