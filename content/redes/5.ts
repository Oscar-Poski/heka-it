...
const capitulo: Capitulo = {
  ...
  secciones: [
    ...
    },
    {
      ...
      texto:
        "La diferencia no es solo un candado en el navegador.",
      partes: [
        {
          id: "http",
          label: "HTTP",
    ...
    },
    {
      ...
      opciones: [
        {
          texto: "El servidor tuvo un error interno y no pudo responder.",
          correcta: false,
        },
        {
          texto: "La página no existe en esa URL.",
          correcta: false,
        },
        {
          texto: "No tienes permiso para acceder a ese recurso.",
          correcta: true,
        },
        {
          texto: "La petición fue exitosa pero el contenido está vacío.",
          correcta: false,
        },
      ],
      feedbackCorrecto:
